...
const allProjects = [
  ...
  },
  {
    ...
    description: "Advanced analytics dashboard for e-commerce businesses with real-time sales tracking, inventory management, and customer insights.",
    image: nagarBazaarImage,
  ...
  },
  {
    ...
    description: "Intelligent chatbot platform with natural language processing, automated responses, and seamless integration capabilities.",
    image: filingWorldImage,
